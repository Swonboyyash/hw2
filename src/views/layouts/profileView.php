            ...
            <div class="row row-offcanvas row-offcanvas-right">
                <div class="jumbotron container-fluid">
                    ...
                    <p> Here is your profile.
                        You can edit your preferences here. </p>
                    </div>
                    ...
                    <div class="row">
                          <div class="col-xs-6 col-lg-4">
                              <form action="homePage.php?action=edit" method="post">
                                  ...
                                  <h5> <strong> DOB: </strong> <? echo $this->userObject['dob']?> </h5><br><br>
                                  ...
                                  <h5> <strong> Favorite Actor: </strong> <? echo $this->userObject['faveactor']?> </h5>
